...
<div class="container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page"><a href="{{ route('admin.eventChildrenNoSpeaker.index', $id) }}">Lista de Eventos Integrantes</a></li>
            <li class="breadcrumb-item active" aria-current="page">Criar Evento Integrante</li>
        </ol>
    </nav>
</div>
<div class="container">
    <div class="justify-content-center">
            <div class="card box-shadow">
                ...
                <div class="card-body">
                    <div class="card-text">
                        <form method="POST" action="{{ route('admin.eventChildrenNoSpeaker.update', $event->id) }}" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                            {{ method_field('PUT') }}
